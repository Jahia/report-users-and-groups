...
@GraphQLName("ReportUsersAndGroupsMutation")
@GraphQLDescription("Report Users and Groups mutations")
public class ReportUsersAndGroupsMutation {

    private static final Logger LOGGER = LoggerFactory.getLogger(ReportUsersAndGroupsMutation.class);
